...
try:
    ...
    assessment = "> Image quality assessment (IQA) for denoising (1x)" + '\n' + \
        "Target : " + OUTPUT_NAME + '\n' + \
        "Reference : " + REFERECE + '\n' + \
    ...
    axs[1].set_title('Enhanced Denoised')
    ...
    print('Saving result for image denoise comparison in image...' + '\n')

    fig.savefig('output/denoise/compare-denoise.png') 
    plt.close()
