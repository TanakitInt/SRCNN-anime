...
INPUT_NAME = "output/1-bicubic-enhanced-downscaled.png"
OUTPUT_NAME = "output/denoise/1-bicubic-enhanced-downscaled-denoised.png"
REFERECE = "input/1.png"
...
try:
    ...
    assessment = "> Image quality assessment (IQA) for denoising (Bicubic UPDOWN-2x)" + '\n' + \
        "Target : " + OUTPUT_NAME + '\n' + \
        "Reference : " + REFERECE + '\n' + \
    ...
    axs[0].set_title('Bicubic Downscaled')
    axs[1].imshow(cv2.cvtColor(denoise_2, cv2.COLOR_BGR2RGB))
    axs[1].set_title('Bicubic Downscaled Enhanced Denoised')
    ...
    fig.savefig('output/denoise/compare-bicubic-downscale-denoise.png') 
    plt.close()
